...
let exh = game_data.read_excel_sheet_header("WeeklyLotBonus")?;let exd = game_data.read_excel_sheet("WeeklyLotBonus", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}
pub fn get_row(&self, id: u32) -> Option<WeeklyLotBonusRow> {
...
pub fn WeeklyLotBonusParam(&self) -> [&ColumnData; 32] {

...
let exh = game_data.read_excel_sheet_header("Attributive")?;let exd = game_data.read_excel_sheet("Attributive", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}
pub fn get_row(&self, id: u32) -> Option<AttributiveRow> {

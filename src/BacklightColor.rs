...
pub struct BacklightColorSheet {
exd: EXD,
exh: EXH,
}
impl BacklightColorSheet {
...
pub fn get_row(&self, row_id: u32) -> Option<BacklightColorRow> {
...
pub fn get_subrow(&self, row_id: u32, subrow_id: u16) -> Option<BacklightColorRow> {
let Some(row) = &self.exd.get_row(row_id) else { return None; };
let row = match row {

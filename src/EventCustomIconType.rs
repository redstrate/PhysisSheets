...
let exh = game_data.read_excel_sheet_header("EventCustomIconType")?;let exd = game_data.read_excel_sheet("EventCustomIconType", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}
pub fn get_row(&self, id: u32) -> Option<EventCustomIconTypeRow> {

...
pub struct CharaCardPlayStyleSheet {
exd: EXD,
exh: EXH,
}
impl CharaCardPlayStyleSheet {
...
pub fn get_row(&self, row_id: u32) -> Option<CharaCardPlayStyleRow> {
...
pub fn get_subrow(&self, row_id: u32, subrow_id: u16) -> Option<CharaCardPlayStyleRow> {
let Some(row) = &self.exd.get_row(row_id) else { return None; };
let row = match row {

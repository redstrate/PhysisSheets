...
pub struct MapConditionSheet {
exd: EXD,
exh: EXH,
}
impl MapConditionSheet {
...
fn read_row(&self, row: &ExcelSingleRow) -> Option<MapConditionRow> {
...
pub fn get_row(&self, row_id: u32) -> Option<MapConditionRow> {
...
pub fn get_subrow(&self, row_id: u32, subrow_id: u16) -> Option<MapConditionRow> {
let Some(row) = &self.exd.get_row(row_id) else { return None; };
let row = match row {

...
pub struct DeepDungeonMagicStoneSheet {
exd: EXD,
exh: EXH,
}
impl DeepDungeonMagicStoneSheet {
...
pub fn get_row(&self, row_id: u32) -> Option<DeepDungeonMagicStoneRow> {
...
pub fn get_subrow(&self, row_id: u32, subrow_id: u16) -> Option<DeepDungeonMagicStoneRow> {
let Some(row) = &self.exd.get_row(row_id) else { return None; };
let row = match row {

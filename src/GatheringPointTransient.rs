...
pub struct GatheringPointTransientSheet {
exd: EXD,
exh: EXH,
}
impl GatheringPointTransientSheet {
...
pub fn get_row(&self, row_id: u32) -> Option<GatheringPointTransientRow> {
...
pub fn get_subrow(&self, row_id: u32, subrow_id: u16) -> Option<GatheringPointTransientRow> {
let Some(row) = &self.exd.get_row(row_id) else { return None; };
let row = match row {

...
pub struct ContentAttributeRect {
exd: EXD,
exh: EXH,
}
impl ContentAttributeRect {
pub fn read_from(game_data: &mut GameData, language: Language) -> Self {
let exh = game_data.read_excel_sheet_header("ContentAttributeRect").unwrap();let exd = game_data.read_excel_sheet("ContentAttributeRect", &exh, language, 0).unwrap();Self {
exh,
exd,
}
}
pub fn get_row(&self, id: u32) -> ContentAttributeRectRow {let ExcelRowKind::SingleRow(row) = &self.exd.get_row(id).unwrap() else { panic!("Expected a single row!"); };
ContentAttributeRectRow { columns: row.columns.clone() }
}
}
...
pub fn Unknown104(&self) -> &ColumnData {
&self.columns[104]
}
pub fn Unknown105(&self) -> &ColumnData {
&self.columns[105]
}
pub fn Unknown106(&self) -> &ColumnData {
&self.columns[106]
}
pub fn Unknown107(&self) -> &ColumnData {
&self.columns[107]
}
pub fn Unknown108(&self) -> &ColumnData {
&self.columns[108]
}
pub fn Unknown109(&self) -> &ColumnData {
&self.columns[109]
}
pub fn Unknown110(&self) -> &ColumnData {
&self.columns[110]
}
pub fn Unknown111(&self) -> &ColumnData {
&self.columns[111]
}
pub fn Unknown112(&self) -> &ColumnData {
&self.columns[112]
}
pub fn Unknown113(&self) -> &ColumnData {
&self.columns[113]
}
pub fn Unknown114(&self) -> &ColumnData {
&self.columns[114]
}
pub fn Unknown115(&self) -> &ColumnData {
&self.columns[115]
}
pub fn Unknown116(&self) -> &ColumnData {
&self.columns[116]
}
pub fn Unknown117(&self) -> &ColumnData {
&self.columns[117]
}
pub fn Unknown118(&self) -> &ColumnData {
&self.columns[118]
}
pub fn Unknown119(&self) -> &ColumnData {
&self.columns[119]
}
pub fn Unknown120(&self) -> &ColumnData {
&self.columns[120]
}
pub fn Unknown121(&self) -> &ColumnData {
&self.columns[121]
}
pub fn Unknown122(&self) -> &ColumnData {
&self.columns[122]
}
pub fn Unknown123(&self) -> &ColumnData {
&self.columns[123]
}
pub fn Unknown124(&self) -> &ColumnData {
&self.columns[124]
}
pub fn Unknown125(&self) -> &ColumnData {
&self.columns[125]
}
pub fn Unknown126(&self) -> &ColumnData {
&self.columns[126]
}
pub fn Unknown127(&self) -> &ColumnData {
&self.columns[127]
}
}

...
let exh = game_data.read_excel_sheet_header("PvPSeries")?;let exd = game_data.read_excel_sheet("PvPSeries", &exh, language, 0)?;Some(Self {
exh,
exd,
})
}
pub fn get_row(&self, id: u32) -> Option<PvPSeriesRow> {
...
impl PvPSeriesRow {
pub fn LevelRewards(&self) -> [&ColumnData; 32] {

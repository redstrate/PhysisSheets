...
pub struct MJIHudModeSheet {
exd: EXD,
exh: EXH,
}
impl MJIHudModeSheet {
...
pub fn get_row(&self, row_id: u32) -> Option<MJIHudModeRow> {
...
pub fn get_subrow(&self, row_id: u32, subrow_id: u16) -> Option<MJIHudModeRow> {
let Some(row) = &self.exd.get_row(row_id) else { return None; };
let row = match row {
